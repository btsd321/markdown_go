...
const ZH: Dict = {
  ...
  'dialog.table.hint': '点击选择行 × 列',
  'table.rowAbove': '上方插入行',
  'table.rowBelow': '下方插入行',
  'table.rowDelete': '删除当前行',
  'table.colLeft': '左侧插入列',
  'table.colRight': '右侧插入列',
  'table.colDelete': '删除当前列',
  'table.alignLeft': '本列左对齐',
  'table.alignCenter': '本列居中',
  'table.alignRight': '本列右对齐',
  'table.delete': '删除整张表格',
  ...
  'bubble.typeBtnDisabledInTable': '表格单元格内不允许切换块类型',
...
const EN: Dict = {
  ...
  'block.video': 'Video',
  'block.table': 'Table',
  'dialog.table.title': 'Insert Table',
  'dialog.table.hint': 'Click to choose rows × cols',
  ...
  'table.alignLeft': 'Align Column Left',
  'table.alignCenter': 'Align Column Center',
  'table.alignRight': 'Align Column Right',
  ...
  'bubble.typeBtnDisabledInTable': 'Block type cannot be changed inside a table cell',
